        ...
        this.model = [
            {
                ...
                items: [
                    { label: 'Cards y Galleria', icon: 'pi pi-fw pi-home', routerLink: ['/admin/cliente'] },
                    { label: 'Formulario', icon: 'pi pi-fw pi-user', routerLink: ['/admin/perfil'] }
                ]
            },
            {
                label: 'Inventario',
                items: [
                    { label: 'Tema libre', icon: 'pi pi-fw pi-id-card', routerLink: ['/admin/categoria'] },
